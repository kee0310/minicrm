      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 max-w-3xl m-5" align="left">
        <form method="POST" action="{{ route('clients.store') }}">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <x-input-label for="client_id_preview" :value="__('Client ID')" />
              <x-text-input id="client_id_preview" class="block mt-1 w-full bg-gray-100" type="text"
                :value="$nextClientId" readonly />
            </div>
            ...
            <div>
              ...
              <x-text-input id="ic_passport" class="block mt-1 w-full" type="text" name="ic_passport"
                :value="old('ic_passport')" />
            ...
            <div>
              ...
              <x-text-input id="monthly_income" class="block mt-1 w-full" type="number" step="0.01"
